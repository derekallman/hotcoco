...
- **Format conversion** — COCO ↔ YOLO, COCO ↔ Pascal VOC, COCO ↔ CVAT, and COCO ↔ DOTA in either direction, from Python or the CLI. See [format conversion](https://derekallman.github.io/hotcoco/guide/conversion/).
